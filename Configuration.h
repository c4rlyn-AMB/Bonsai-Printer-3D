...
#define CUSTOM_MACHINE_NAME "Printer 3D Dual"
...
#define HOTEND_OFFSET_X {0.0, 17.00} // (in mm) for each extruder, offset of the hotend on the X axis
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 400, 95, 95 }
 ...
 *                                      X, Y, Z, E0 , E1 [, E2[, E3[, E4]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 150, 150, 4, 25, 25 }
...
#define PREHEAT_2_TEMP_HOTEND 310
